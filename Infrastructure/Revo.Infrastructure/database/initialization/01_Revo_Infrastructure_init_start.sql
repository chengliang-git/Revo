...
*/
CREATE TABLE [dbo].[REV_TEMP_INIT_DB_VERSION] (
...
INSERT INTO [REV_TEMP_INIT_DB_VERSION] (REV_DBV_DbVersionId, REV_DBV_ModuleId, REV_DBV_Version, REV_DBV_MinModuleVersion, REV_DBV_MaxModuleVersion)
...
INSERT INTO [dbo].[REV_TEMP_SCRIPT_LOG] ([REV_SCL_ScriptLogId],[REV_SCL_ScriptId],[REV_SCL_ScriptType],[REV_SCL_ScriptName],[REV_SCL_DbVersionId],[REV_SCL_StartTimestamp],[REV_SCL_CompletionTimestamp])
VALUES (@logId, '5981AF9B-5BC3-44BD-A7D7-572FB328AABA', 'STRUCTURE', '01_Revo_Infrastructure_init_start', 'DCB948CF-C9DB-41C9-AE9C-C08E97BC87B2', @timestamp, @timestamp);
